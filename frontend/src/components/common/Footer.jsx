/**
 * Main footer component with links and company information
 */
    ...
    <footer className="bg-gray-200 text-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">easyLuxury</span>
            </Link>
            <p className="text-black mb-4 max-w-md">
              Experience luxury travel like never before. Book premium bus services with real-time tracking, 
              comfortable amenities, and exceptional service across India.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-300 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 flex space-x-6 text-sm text-black">
