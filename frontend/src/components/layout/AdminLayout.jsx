/**
 * Admin layout wrapper with sidebar and main content area
          ...
          <div className="flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden sm:flex items-center space-x-2 text-sm text-gray-500">
                <span>Role:</span>
                <span className="px-2 py-1 bg-accent text-gray-900 rounded-full text-xs font-semibold">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="w-10 h-10 bg-black40 rounded-full flex items-center justify-center">
