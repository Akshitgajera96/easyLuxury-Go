...
const Login = () => {
  ...
  const handleDemoLogin = (role = "user") => {
    const demoAccounts = {
      user: { email: "demo@easyluxury.com", password: "Demo@123" },
      admin: { email: "admin@easyluxury.com", password: "Admin@123" },
      captain: { email: "captain@easyluxury.com", password: "Captain@123" }
    };
