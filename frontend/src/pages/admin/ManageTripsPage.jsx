        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              <strong>Note:</strong> Past trips (those with departure dates before today) are automatically marked as <strong>Expired</strong>. Expired trips are displayed with a gray badge and cannot be edited or canceled.
            </p>
          </div>
        </div>
      </div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div className="flex space-x-2">
                      <select
                        ...
                        className="text-xs border border-gray-300 rounded px-2 py-1 focus:ring-2 focus:ring-accent disabled:opacity-50 disabled:cursor-not-allowed"
                      >
